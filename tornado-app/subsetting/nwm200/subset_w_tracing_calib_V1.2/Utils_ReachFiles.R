# This script contains all the functions called in other scripts. 
# One does not need to touch this part of the script, unless there are fundamental changes to the domain files
