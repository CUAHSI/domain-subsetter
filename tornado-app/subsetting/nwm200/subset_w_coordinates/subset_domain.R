...
y_south <- 382582.18746
y_north <- 367584.87840
x_west <- 1720355.72762
x_east <- 1734488.45260
...
fullHydFile <- "../../data/Fulldom_hires_netcdf_250m.nc"

# Path to the Geogrid domain file
fullGeoFile <- "../../data/geo_em.d01_1km.nc"

# Path to the Wrfinput domain file
fullWrfFile <- "../../data/wrfinput_d01_1km.nc"

# Path to the Routelink file
#fullRtlinkFile <- NULL
fullRtlinkFile <- "../../data/RouteLink_NHDPLUS.nc"

# Path to the Spatial weights file
#fullSpwtFile <- NULL
fullSpwtFile <- "../../data/spatialweights_250m_all_basins.nc"

# Path to the GW bucket parameter file
fullGwbuckFile <- "../../data/GWBUCKPARM_CONUS.nc"

# Path to the Soil parameter file
fullSoilparmFile <- "../../data/soil_veg_properties_ASM.nc"
